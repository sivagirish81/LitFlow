  ...
  return (
    <main className="mx-auto grid min-h-[85vh] max-w-6xl place-items-center p-8">
      <section className="w-full rounded-3xl border border-black/10 bg-white/70 p-10 shadow-xl">
        <p className="text-sm uppercase tracking-[0.24em] text-zinc-500">Research intelligence stack</p>
        <h1 className="mt-4 text-6xl font-semibold leading-tight">LitFlow</h1>
        <p className="mt-5 max-w-2xl text-lg text-zinc-700">Upload real PDFs, ingest through automated pipelines, ask citation-backed questions, build surveys, and inspect your topic graph.</p>
